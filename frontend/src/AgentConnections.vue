...
<style scoped>
.agent-overview{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:22px 0 28px}.agent-overview>div{display:flex;align-items:baseline;gap:10px;padding:15px 18px;border:1px solid var(--line);border-radius:9px;background:var(--soft)}.agent-overview strong{font-size:24px;line-height:1.2}.agent-overview span{font-size:12px;color:var(--muted)}.agent-overview .configured strong{color:var(--good)}.agent-overview .attention strong{color:var(--warn)}.agent-section{margin-top:26px}.agent-section-heading{margin-bottom:12px}.agent-section-heading h2{font-size:14px}.agent-section-heading h2 span{color:var(--muted);font-weight:400;margin-left:6px}.agent-section-heading p{color:var(--muted);font-size:11px;margin-top:4px}.agent-card{border:1px solid var(--line);border-left:3px solid var(--line);border-radius:9px;padding:17px 18px;margin-top:10px;background:var(--bg)}.agent-card.configured{border-left-color:var(--good)}.agent-card.attention{border-left-color:var(--warn)}.agent-card-top{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.agent-card-top h3{flex:1;font-size:14px}.agent-card-top .service-symbol{width:28px;height:28px;font-size:12px}.agent-message{font-size:12px;color:var(--muted);overflow-wrap:anywhere;margin-top:12px}.agent-card .warning-text{font-size:11px}.agent-card-bottom{display:flex;gap:16px;align-items:flex-end;justify-content:space-between;margin-top:17px;padding-top:13px;border-top:1px solid var(--line)}.agent-config-path{min-width:0}.agent-config-path span{display:block;font-size:10px;color:var(--muted);margin-bottom:3px}.agent-config-path code{font-size:10px;color:var(--muted);overflow-wrap:anywhere}.agent-card-bottom .actions{flex-shrink:0}
@media(max-width:850px){.agent-card-bottom{align-items:flex-start;flex-direction:column}.agent-overview>div{padding:12px;gap:5px;flex-wrap:wrap}}@media(max-width:600px){.agent-overview{gap:7px}.agent-overview>div{flex-direction:column}.agent-overview strong{font-size:21px}.agent-overview span{font-size:11px}.agent-card{padding:14px}.agent-card-top .badge{margin-left:38px}.agent-card-top h3{flex-basis:calc(100% - 40px)}}
</style>
